                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center gap-2">
                                            <a href="{{ $linkPelanggan }}" 
                                               ...
                                               class="text-blue-600 hover:text-blue-800 hover:underline inline-flex items-center gap-2 text-sm font-medium">
                                                <i class="fas fa-link"></i>
                                                <span class="truncate max-w-md">{{ $linkPelanggan }}</span>
                                            </a>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center gap-2">
                                            <a href="{{ $linkHistory }}" 
                                               target="_blank" 
                                               rel="noopener noreferrer"
                                               class="text-purple-600 hover:text-purple-800 hover:underline inline-flex items-center gap-2 text-sm font-medium">
                                                <i class="fas fa-history"></i>
                                                <span class="truncate max-w-md">{{ $linkHistory }}</span>
                                            </a>
