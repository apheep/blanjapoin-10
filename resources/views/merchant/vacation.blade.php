<section id="section-vacation" class="mt-10 md:mt-14">
 ...
 <div data-voucher-container="true" data-voucher-section="vacation" data-container-type="primary" class="card-container grid grid-cols-2 gap-3 lg:grid-cols-2 lg:gap-5 items-stretch px-1">
 ...
 <div id="extraVacationCard" class="group max-h-0 overflow-hidden opacity-0 scale-y-0 origin-top transition-all duration-500 ease-in-out mt-6 md:mt-10">
  <div data-voucher-container="true" data-voucher-section="vacation" data-container-type="extra" class="card-container grid grid-cols-2 gap-3 lg:grid-cols-2 lg:gap-5 items-stretch px-1">
