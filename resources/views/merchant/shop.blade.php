    <section id="section-shop" class="mt-10 md:mt-14 mb-10 md:mb-14">
     ...
     <div id="shopCardContainer" class="card-container grid grid-cols-2 gap-3 lg:grid-cols-1 lg:gap-5 items-stretch px-1">
      ...
      <article onclick="window.open('{{ $keyword->cta_link ?? '#' }}', '_blank')" class="group overflow-hidden rounded-xl md:rounded-2xl border border-neutral-200 bg-white shadow-md transition-all hover:shadow-xl hover:border-rose-200 cursor-pointer opacity-0 translate-y-2 duration-200 ease-out h-full min-h-[280px]">
       <!-- Mobile Layout -->
    ...
    @endif
      ...
      <div class="mt-12 md:mt-10 flex justify-center relative z-20 md:static md:z-auto pointer-events-auto">
       <button onclick="toggleShopCards()" id="shopSeeAllBtn" class="text-sm font-bold text-rose-600 hover:text-rose-700 transition-all flex items-center gap-2 group px-4 py-2 rounded-full hover:bg-rose-50 bg-white/80 backdrop-blur-sm shadow-sm md:bg-transparent md:backdrop-blur-0 md:shadow-none">
