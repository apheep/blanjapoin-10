                    ...
                    <div class="flex space-x-3">
                        <div class="relative">
                            ...
                            <div id="statusDropdownKeyword" class="hidden absolute md:left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl p-3 border border-gray-200 w-56 z-40">
                                <div class="py-1">
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors duration-200" onclick="filterKeywordByStatus('all'); return false;">All</a>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-yellow-900 rounded-lg transition-colors duration-200" onclick="filterKeywordByStatus('pending'); return false;">Pending</a>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-red-100 hover:text-red-900 rounded-lg transition-colors duration-200" onclick="filterKeywordByStatus('reject'); return false;">Rejected</a>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100 hover:text-green-900 rounded-lg transition-colors duration-200" onclick="filterKeywordByStatus('approve'); return false;">Approved</a>
                                </div>
                            </div>
                        </div>
