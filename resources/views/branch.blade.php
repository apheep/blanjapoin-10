...
<head>
    ...
    <title>Merchant Branch {{ $locationName }} - BlanjaPoin</title>
        ...
        <main class="mx-auto w-full max-w-[1400px] px-4 md:px-8 lg:px-10 pb-12 relative z-10">
            ...
            <div class="mt-8 md:mt-12 mb-8">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                    Merchant di Branch {{ $locationName }}
                </h1>
                <p class="text-gray-600">
                    Temukan merchant dan promo menarik di Branch {{ $locationName }}
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 lg:grid-cols-3 lg:gap-5 items-stretch px-1">
                @foreach($keywords as $keyword)
                    @php
                        ...
                        $uniqueId = 'branch-card-' . $keyword->id;
                    @endphp
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Belum ada merchant di Branch {{ $locationName }}</h3>
