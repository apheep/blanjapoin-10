    ...
    <div class="w-full bg-white relative overflow-hidden">
        ...
        <main class="mx-auto w-full max-w-[1400px] px-4 md:px-8 lg:px-10 pb-12 relative z-10">
            ...
            @php
                ...
                $hasCategoryData = function($category) use ($keywords, $isBranch) {
                    return $keywords->filter(function ($keyword) use ($category, $isBranch) {
                        ...
                        $baseCondition = $keyword->merchant && $keywordCategory === $category
                            ...
                            && $keyword->is_active == 1;
                        // Skip validasi merchant->is_active jika di halaman branch
                        return $isBranch 
                            ? $baseCondition 
